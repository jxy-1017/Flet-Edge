...
1. Generate the sub configuration file to be drawn, which contains the information of different programs_ Time value.

2. To information_ time_ The plot.py file passes in the list that needs to be combined.
