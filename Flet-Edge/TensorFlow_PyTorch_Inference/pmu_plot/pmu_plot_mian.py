...
1. Generate the sub configuration file to be drawn, which contains the PMU values of different programs.

2. To PMU_ The plot.py file passes in the list that needs to be combined.
